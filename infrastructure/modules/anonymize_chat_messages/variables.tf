...
variable "filename" {
  description = "Path to the anonymize_chat_messages deployment package .zip file."
  type        = string
}

variable "role_arn" {
  description = "ARN of the IAM execution role (anonymize_chat_messages) to assign to the Lambda function."
  type        = string
}
