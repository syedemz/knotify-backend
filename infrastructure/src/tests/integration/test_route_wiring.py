...
Routes under test (20 total, enumerated from dev/main.tf):
...
def test_all_expected_routes_exist_with_jwt_authorization():
    ...
    # Route count: 4 (profile) + 7 (friends) + 3 (bookmarks) + 3 (blocks) + 2 (match) + 1 (push-tokens) = 20
