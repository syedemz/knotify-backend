"""
pytest configuration for the knotify-match function unit tests.
...
# Functions live at: infrastructure/src/functions/match/tests/  (this file)
# Layers live at:    infrastructure/src/layers/{db,observability}/
# Path traversal: tests/ -> match/ -> functions/ -> src/
