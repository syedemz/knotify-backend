"""
pytest configuration for the knotify-friends function unit tests.
...
# Functions live at: infrastructure/src/functions/friends/tests/  (this file)
# Layers live at:    infrastructure/src/layers/{db,observability}/
# Path traversal: tests/ -> friends/ -> functions/ -> src/
