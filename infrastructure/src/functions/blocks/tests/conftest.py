"""
pytest configuration for the knotify-blocks function unit tests.
...
# Functions live at: infrastructure/src/functions/blocks/tests/  (this file)
# Layers live at:    infrastructure/src/layers/{db,observability}/
# Path traversal: tests/ -> blocks/ -> functions/ -> src/
