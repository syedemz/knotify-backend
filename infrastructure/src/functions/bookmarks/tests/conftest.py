"""
pytest configuration for the knotify-bookmarks function unit tests.
...
# Functions live at: infrastructure/src/functions/bookmarks/tests/  (this file)
# Layers live at:    infrastructure/src/layers/{db,observability}/
# Path traversal: tests/ -> bookmarks/ -> functions/ -> src/
