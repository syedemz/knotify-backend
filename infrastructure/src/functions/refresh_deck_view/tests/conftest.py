"""
pytest configuration for the knotify-refresh-deck-view function unit tests.
...
# Functions live at: infrastructure/src/functions/refresh_deck_view/tests/  (this file)
# Layers live at:    infrastructure/src/layers/{db,observability}/
# Path traversal: tests/ -> refresh_deck_view/ -> functions/ -> src/
