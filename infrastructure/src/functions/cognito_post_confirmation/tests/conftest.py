"""
pytest configuration for cognito_post_confirmation tests.
...
#   infrastructure/src/functions/cognito_post_confirmation/handler.py
# which is two levels above this conftest.py (tests/ -> cognito_post_confirmation/)
...
# Re-uses the same pattern as the db layer conftest.
# ---------------------------------------------------------------------------
